...
class IsometricScene extends Phaser.Scene {
    ...
    create() {
        ...
        const manualBoxes = Array.from({ length: BOARD_HEIGHT }, (_, y) =>
            Array.from({ length: BOARD_WIDTH }, (_, x) => {
                // Create boxes with varying elevations for visual demonstration
                const elevation = (x + y) % 3;
                return new Box(x, y, { elevation });
            }),
        ).flat();
    ...
    return (
        <section
            style={{
                ...
                background: 'radial-gradient(circle at 50% 20%, #232323 0%, #0b0b0b 65%)',
            }}
        >
            <div
                ref={containerRef}
